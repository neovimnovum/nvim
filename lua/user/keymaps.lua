...
legendary.setup({
    ...
    keymaps = {
        { '<C-h>', '<C-w>h', description = 'Move cursor to window left' },
        { '<C-j>', '<C-w>j', description = 'Move cursor to window down' },
        { '<C-k>', '<C-w>k', description = 'Move cursor to window up' },
        { '<C-l>', '<C-w>l', description = 'Move cursor to window right' },
        { '<C-Up>', ':resize -2<CR>', description = 'Grow top split' },
        { '<C-Down>', ':resize +2<CR>', description = 'Grow bottom split' },
        { '<C-Left>', ':vertical resize -2<CR>', description = 'Grow left split' },
        { '<C-Right>', ':vertical resize +2<CR>', description = 'Grow right split' },
        { '<S-l>', ':bnext<CR>', description = 'Switch to buffer right' },
        { '<S-h>', ':bprevious<CR>', description = 'Switch to buffer left' },
        { '<Leader>e', ':NvimTreeToggle<CR>', description = 'Open NvimTree' },
        { '<Leader>k', legendary.find, description = 'Keymap legend' },
        { '<Leader>d', vim.diagnostic.open_float, description = 'Open overlay diagnostic'}
    },
    ...
    default_opts = {
        keymaps = { remap = false, silent = true },
